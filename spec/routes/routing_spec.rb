...
describe 'Routing' do
  ...
  describe 'Welcome Controller', :type => :routing do
    ...
    context '#archive' do
      it { expect(get: '/2015').to route_to(controller: 'posts', action: 'archives', year: '2015') }
      it { expect(get: '/2015/04').to route_to(controller: 'posts', action: 'archives', year: '2015', month: '04') }
      it { expect(get: '/2015/04/20').to route_to(controller: 'posts', action: 'archives', year: '2015', month: '04', day: '20') }
    end
