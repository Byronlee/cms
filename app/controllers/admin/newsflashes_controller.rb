class Admin::NewsflashesController < Admin::BaseController
  ...
  def newsflash_params
    params.require(:newsflash).permit(:hash_title, :catch_title, :tag_list, :description_text, :news_url, :news_url_type, :site_url, :product_url, :column_id, :what, :how, :think_it_twice, :cover, :display_in_infoflow, :pin)
  end
end
