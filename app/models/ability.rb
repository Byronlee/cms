class Ability
  ...
  def anonymous
    ...
    can [:read, :posts], User
    can [:news, :feed, :hots, :today_lastest, :feed_bdnews, :bdnews, :archives, :preview, :baidu_feed, :xiaozhi_feed, :xiaozhi_news, :chouti_feed, :chouti_news, :uc_feed, :ucnews, :partner_feed, :toutiao_news, :toutiao_feed], Post
