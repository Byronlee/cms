...
xml.urlset :xmlns => "http://36kr.com/sitemap/0.9" do
  ...
  @authors.each do |author|
  	if author.domain.present?
	  	xml.url do
	      xml.loc "http://www.36kr.com/posts/#{author.domain}.html"
  ...
  @columns.each do |column|
  	xml.url do
      xml.loc "http://www.36kr.com/columns/#{column.slug}.html"
  ...
  @newsflashs.each do |newsflash|
  	xml.url do
      xml.loc "http://www.36kr.com/clipped/#{newsflash.id}.html"
